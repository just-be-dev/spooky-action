...
// gesture engine (src/gestures/engine.ts), rebuilt as a Foldkit program.
...
// backend (src/gestures/main.ts), which drives the native overlay.
import {
  FaceLandmarker,
  FilesetResolver,
  HandLandmarker,
...
import {
  ...
  type Entity,
  type WireMessage,
} from "../gestures/engine";
import { FACE_LANDMARKS, HAND_LANDMARKS } from "../gestures/landmarks";
import {
  LandmarkPoint,
  TrackState,
  initialTrackState,
